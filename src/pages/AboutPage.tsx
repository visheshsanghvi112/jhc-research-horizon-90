...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About the Big Data Project | Jai Hind College</title>
        <meta name="description" content="Know the vision, team, and scope behind this academic research initiative in Big Data Analytics at Jai Hind College." />
        <meta property="og:title" content="About the Big Data Project | Jai Hind College" />
        <meta property="og:description" content="Know the vision, team, and scope behind this academic research initiative in Big Data Analytics at Jai Hind College." />
        <meta property="og:url" content="https://jhc2025.vercel.app/about" />
      </Helmet>
        ...
        <section className="pt-20 pb-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                Discover the comprehensive MSc Big Data Analytics research project conducted at Jai Hind College, 
                exploring data-driven insights and predictive analytics methodologies.
              </motion.p>
              ...
              >
                ...
                <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-white/90 border border-white/20 text-sm">
                  <span className="font-semibold">📊 Data Science Research</span>
                </div>
                <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-white/90 border border-white/20 text-sm">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 leading-tight">
                Jai Hind College Big Data Analytics
              </h2>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                This comprehensive research project represents the culmination of MSc Big Data Analytics studies, 
                demonstrating practical applications of data science methodologies and predictive analytics.
              </p>
            </motion.div>
        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                A comprehensive MSc Big Data Analytics research project exploring advanced data science methodologies, 
                predictive modeling, and data visualization techniques in real-world applications.
              </p>
            </motion.div>
