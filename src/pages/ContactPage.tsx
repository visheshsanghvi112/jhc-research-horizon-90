...
const ContactPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact | MSc Big Data Analytics Research | Vishesh Sanghvi</title>
        <meta name="description" content="Contact information for MSc Big Data Analytics research project. Connect with student researcher Vishesh Sanghvi at Jai Hind College Mumbai." />
        <meta property="og:title" content="Contact | MSc Big Data Analytics Research | Vishesh Sanghvi" />
        <meta property="og:description" content="Contact information for MSc Big Data Analytics research project. Connect with student researcher Vishesh Sanghvi at Jai Hind College Mumbai." />
        <meta property="og:url" content="https://jhc2025.vercel.app/contact" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-bold text-primary mb-6">Research Contact</h2>
                  <p className="text-muted-foreground text-lg mb-8">
                    Have questions about this Big Data Analytics research project? Contact the student researcher for academic discussions and inquiries.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground font-medium">vishesh.research@jaihindcollege.edu.in</p>
                      <p className="text-sm text-muted-foreground mt-2">
                        For research inquiries, collaboration, and academic discussions
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-muted-foreground mt-2">
                        Jai Hind College - MSc Big Data Analytics Department
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-lg transition-shadow duration-300">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        <strong>Vishesh Sanghvi</strong><br />
